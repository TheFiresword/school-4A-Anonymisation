...
#Le but de cette métrique est de calculer la différence de zone de couverture d'un individu durant les 10 semaines d'étude.
#L'idée est la suivante : la métrique permet de vérifier que, globalement, la version anonymisée garde les informations de déplacement 
# et de couverture d'un individu.
